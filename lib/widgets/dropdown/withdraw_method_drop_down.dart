...
import 'package:stripcard/backend/model/withdraw/withdraw_info_model.dart';
import '../../utils/custom_color.dart';
import '../../utils/custom_style.dart';
import '../../utils/dimensions.dart';

class WithdrawMethodDropDown extends StatelessWidget {
  final RxString selectMethod;
  final List<Currency> itemsList;
  final void Function(Currency?)? onChanged;

  const WithdrawMethodDropDown({
